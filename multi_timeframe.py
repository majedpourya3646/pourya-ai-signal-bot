...
def analyze_symbol(symbol):
    ...
    try:
        ...
        score = round(
            ...
            r15["confidence"] * TIMEFRAME_WEIGHTS["15m"]

            +

            r1h["confidence"] * TIMEFRAME_WEIGHTS["1h"]

            +

            r4h["confidence"] * TIMEFRAME_WEIGHTS["4h"]
        ...
        if buy_count == 3 and score >= 75:

            signal = "STRONG BUY"


        elif buy_count >= 2 and score >= 60:
