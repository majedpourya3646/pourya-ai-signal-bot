...
def initialize_mt5():
    ...
    try:
        ...
        #
        # The Portable MT5 terminal is already running and
        # available. Calling shutdown() unnecessarily can break
        # the IPC connection and produce:
        #
...
def get_symbol_info(
    ...
    try:
        ...
        # ----------------------------------------------------
        # Make symbol visible/selectable
        # ----------------------------------------------------
